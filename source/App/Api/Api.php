...
class Api extends Controller
{
    ...
    public function __construct()
    {
        ...
        //MOSTRANDO PRO PHP O MODO DE RESPOSTA E PEGANDO OS HEADERS PARA AUTENTICAÇÃO
        ...
        //AUTENTICANDO USUÁRIO POR TENTATIVA SEM A SESSÃO
        $auth = $this->auth();
        if (!$auth) {
            exit;
        }
    ...
    private function auth(): bool
    {
        ...
        //VERIFICA SE JÁ TEVE TENTATIVAS E SE EXCEDEU MAS NÃO GRAVA NADA
        ...
        if (!$user) {
            // GRAVA NO ARQUIVO JSON DO USUÁRIO A TENTATIVA JÁ QUE ERROU A SENHA
